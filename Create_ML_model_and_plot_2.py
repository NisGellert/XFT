# -*- coding: utf-8 -*-
"""
Created on Sun Apr 24 16:02:29 2022
...
energy_i = np.arange(5.,40.2,0.1) # [keV] Incident energy
theta_i = 0.2 # [deg].Incident angle
...
#highz_layer = [["Ni"], [1,1], [0.45], [8.902]]  #Ni = 8.8, V = 6.11, NiO = 6.67, NiV=8,9
...
Structure = "Periodic" # "Power law", "Linear" or "Periodic"
dmin = 2.5 # [nm] Minimum bi-layer thickness
dmax = 7.101# [nm] Maximum bi-layer thickness. If Periodic structure, d=dmax.
c = 0.225 # Power law variable
gamma = 0.5 # Thickness ratio. We use Gamma high-Z. Gamma high-Z = z high-Z / d 
gamma_top = [False,0.7] 
...
if angleScan:
    ...
    ax3.plot(energy_m/1000,reflectance,'b-',label="Pt/C, N = 10")
    #ax3.plot(energy_m/1000,r_N150,'b-',label="Pt/C, N = 150")
    ax3.set_xlim([5, 40])
    '''
    #ax3.plot(energy_m/1000, r_pt_c_N10_2p5nm_0p1d,marker='',linestyle= '-',label ='Pt/C, N = 10',color='b',linewidth = 3.0,markersize=3)
    #ax3.plot(energy_m/1000, r_pt_c_N25_2p5nm_0p1d,marker='',linestyle= '-',label ='Pt/C, N = 25',color='r',linewidth = 3.0,markersize=3)
    ax3.plot(energy_m/1000, r_pt_c_N100_2p5nm_0p1de,marker='',linestyle= '--',label ='Pt/C, N = 100',color='k',linewidth = 3.0,markersize=3)
    ax3.plot(energy_m/1000, r_pt_c_N25_2p5nm_0p1d,marker='',linestyle= '--',label ='Pt/C, N = 25',color='r',linewidth = 3.0,markersize=3)
  
    ax3.plot(energy_m/1000, r_pt_c_N10_2p5nm_0p1d,marker='',linestyle= '--',label ='Pt/C, N = 10',color='b',linewidth = 3.0,markersize=3)
    #ax3.plot(energy_m/1000, r_pt_c_N10_2p5nm_0p1d_2,marker='',linestyle= '--',label ='Pt/C, N = 10',color='b',linewidth = 3.0,markersize=3)
    


    ax3.plot(energy_m/1000, r_ni_c_N100_2p5nm_0p1d,marker='',linestyle= '-',label ='Ni/C, N = 100',color='k',linewidth = 3.0,markersize=3)
    ax3.plot(energy_m/1000, r_ni_c_N25_2p5nm_0p1d,marker='',linestyle= '-',label ='Ni/C, N = 25',color='r',linewidth = 3.0,markersize=3)    
    ax3.plot(energy_m/1000, r_ni_c_N10_2p5nm_0p1d,marker='',linestyle= '-',label ='Ni/C, N = 10',color='b',linewidth = 3.0,markersize=3)
    plt.axvline(x=142, color='k', label ='142 keV')
    ax3.set_xlabel("Energy (keV)", fontsize = 15)  
    ax3.set_ylabel("Reflectance", fontsize = 15)     
    ax3.set_xlim([130, 160])
    
    plt.text(50, 0.4, '0.1\u00b0, d = 2.5 nm, bragg peak at 142 keV', fontsize = 15)
    
    ax3.grid()
    ax3.legend(handlelength=6, fontsize = 10)

    '''
    plt.axvline(x=25.0, color='k', label ='25.0 keV')
    plt.text(6, 0.5, '0.2\u00b0, d = 7.101 nm, bragg peak at 25.0 keV', fontsize = 12)
    ax3.set_xlabel("Energy (keV)", fontsize = 15)  
    ax3.set_ylabel("Reflectance", fontsize = 15) 
    ax3.legend(handlelength=6, fontsize = 15)
